/*
    ...
    * Promueve la reutilización de código y es una manera flexible de crear subclases y subobjetos sin depender de la herencia 
*/
...
usuario2.saludar = function () {
    console.log(
        `Hola mi nombre es ${this.nombre}, yo vivo en ${this.direccion}`
    );
};
usuario2.saludar();
