...
const listWidget = (function () {
    ...
    return {
        ...
        apiKey: '0398f874dc0338052e5cba17b8a891c6', // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
                ...
                (function (j) {
                    setTimeout(() => {
                        document.querySelector(
                            '.conditions'
                        ).innerHTML = `<p class="animation>00:00:0${j}</p>`;
                    }, 100 * j);
                })(i);
            }
        },
